...
static void ClockSetup(void)
{
	...
	CY_SET_REG32((void CYXDATA *)(CYREG_CLK_IMO_TRIM2), (6u));
	CyDelayCycles(5u);
	CY_SET_REG32((void CYXDATA *)(CYREG_CLK_IMO_TRIM1), (CY_GET_REG8((void *)CYREG_SFLASH_IMO_TRIM03)));
	CyDelayUs(5u);
...
void cyfitter_cfg(void)
{
	...
	CY_SET_REG8((void *)CYREG_UDB_UDBIF_INT_CLK_CTL, 0x01u);
	{
		...
		CY_SET_XTND_REG32((void CYFAR *)(CYREG_PRT0_PC), 0x00240D86u);

		/* IOPINS0_1 Starting address: CYDEV_PRT1_DR */
		CY_SET_XTND_REG32((void CYFAR *)(CYREG_PRT1_DR), 0x00000040u);
		CY_SET_XTND_REG32((void CYFAR *)(CYREG_PRT1_PC), 0x00180018u);
