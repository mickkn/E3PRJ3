...
*
*  Pin_DM_STRONG     Strong Drive 
*  Pin_DM_OD_HI      Open Drain, Drives High 
*  Pin_DM_OD_LO      Open Drain, Drives Low 
*  Pin_DM_RES_UP     Resistive Pull Up 
*  Pin_DM_RES_DWN    Resistive Pull Down 
*  Pin_DM_RES_UPDWN  Resistive Pull Up/Down 
*  Pin_DM_DIG_HIZ    High Impedance Digital 
*  Pin_DM_ALG_HIZ    High Impedance Analog 
*
* Return: 
*  None
*
