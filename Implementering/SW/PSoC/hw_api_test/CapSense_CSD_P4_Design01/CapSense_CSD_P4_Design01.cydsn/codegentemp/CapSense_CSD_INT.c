...
extern void CapSense_CSD_PreScan(uint32 sensor);
extern void CapSense_CSD_PostScan(uint32 sensor);
...
extern volatile uint8 CapSense_CSD_sensorEnableMask[];
extern uint8 CapSense_CSD_sensorEnableMaskBackup[];
