...
#include "SPIS_1_SPI_UART_PVT.h"
    ...
    ***************************************/
    ...
    const SPIS_1_SPI_INIT_STRUCT SPIS_1_configSpi =
    {
        ...
        0u,
        NULL,
        (uint32) SPIS_1_SCB_IRQ_INTERNAL,
    ...
    *******************************************************************************/
    void SPIS_1_SpiInit(const SPIS_1_SPI_INIT_STRUCT *config)
    {
        ...
        else
        {
            ...
            CyIntDisable    (SPIS_1_ISR_NUMBER);
            CyIntSetPriority(SPIS_1_ISR_NUMBER, SPIS_1_ISR_PRIORITY);
            (void) CyIntSetVector(SPIS_1_ISR_NUMBER, &SPIS_1_SPI_UART_ISR);
...
void SPIS_1_SpiSetActiveSlaveSelect(uint32 activeSelect)
{
    ...
    spiCtrl &= (uint32) ~SPIS_1_SPI_CTRL_SLAVE_SELECT_MASK;
