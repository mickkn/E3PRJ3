...
#define SPIS_1_SPI_RX_DATA_BITS_NUM       (8u)
#define SPIS_1_SPI_TX_DATA_BITS_NUM       (8u)
...
#define SPIS_1_UART_INTR_RX_MASK          (0u)
...
/* Common APIs Tx direction */
    ...
    void   SPIS_1_SpiUartWriteTxData(uint32 txData);
    void   SPIS_1_SpiUartPutArray(const uint8 wrBuf[], uint32 count);
...
***************************************/
    ...
    /* RX direction */
        ...
        #define SPIS_1_PutWordInRxBuffer(idx, rxDataByte) \
                do{                                                 \
                    SPIS_1_rxBufferInternal[(idx)] = ((uint8) (rxDataByte)); \
                }while(0)
    ...
    /* TX direction */
        ...
        #define SPIS_1_PutWordInTxBuffer(idx, txDataByte) \
                    do{                                             \
                        SPIS_1_txBufferInternal[(idx)] = ((uint8) (txDataByte)); \
                    }while(0)
...
/* SPI master active slave select constants for SPIS_1_SpiSetActiveSlaveSelect() */
...
/* UART stop bits enum */
#define SPIS_1_UART_STOP_BITS_1   (2u)
#define SPIS_1_UART_STOP_BITS_1_5 (3u)
#define SPIS_1_UART_STOP_BITS_2   (4u)
