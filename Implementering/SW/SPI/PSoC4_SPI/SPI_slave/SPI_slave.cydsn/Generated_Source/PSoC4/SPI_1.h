...
#define SPI_1_CY_SCBIP_V1 (CYIPBLOCK_m0s8scb_VERSION >= 1u)
    ...
    #define SPI_1_CY_SCBIP_V1_I2C_ONLY   (1u) /* SCB IP V1 supports only I2C */
#else
    #define SPI_1_CY_SCBIP_V1_I2C_ONLY   (0u) /* SCB IP V0 supports I2C, SPI, UART */
...
#endif /* ((!SPI_1_CY_SCBIP_V1_I2C_ONLY) */
...
#endif /*defined(CYDEV_BOOTLOADER_IO_COMP) && ((CYDEV_BOOTLOADER_IO_COMP == CyBtldr_SPI_1) || \
                                                    (CYDEV_BOOTLOADER_IO_COMP == CyBtldr_Custom_Interface)) */
...
#define SPI_1_CTRL_BLOCK_POS         (17u) /* [17]    Ext and Int logic to resolve colide */
...
/* SPI_1_STATUS_REG */
#define SPI_1_STATUS_EC_BUSY_POS     (0u)  /* [0] Bus busy. Externaly clocked loigc access to EZ memory */
...
#define SPI_1_SPI_CTRL_LOOPBACK_POS          (16u) /* [16]    Local loopback control enabled             */
...
/* SPI_1_UART_CTRL */
#define SPI_1_UART_CTRL_LOOPBACK_POS         (16u) /* [16] Loopback     */
...
/* SPI_1_UART_RX_CTRL */
#define SPI_1_UART_RX_CTRL_STOP_BITS_POS             (0u)  /* [2:0] Stop bits: (Stop bits + 1) * 0.5 prd   */
...
#define SPI_1_UART_RX_CTRL_LIN_MODE_POS              (12u) /* [12]  Lin mode: applicable for UART Standart */
#define SPI_1_UART_RX_CTRL_SKIP_START_POS            (13u) /* [13]  Skip start not: only for UART Standart */
...
#define SPI_1_UART_RX_STATUS_BR_COUNTER_POS     (0u)  /* [11:0] Baute Rate counter */
#define SPI_1_UART_RX_STATUS_BR_COUNTER_MASK    ((uint32) 0xFFFu)

/* SPI_1_I2C_CTRL */
#define SPI_1_I2C_CTRL_HIGH_PHASE_OVS_POS           (0u)   /* [3:0] Oversampling factor high: masrer only */
#define SPI_1_I2C_CTRL_LOW_PHASE_OVS_POS            (4u)   /* [7:4] Oversampling factor low:  masrer only */
#define SPI_1_I2C_CTRL_M_READY_DATA_ACK_POS         (8u)   /* [8]   Master ACKs data wgile RX FIFO != FULL*/
...
#define SPI_1_I2C_CTRL_LOOPBACK_POS                 (16u)  /* [16]  Loopback                              */
...
#define SPI_1_I2C_CFG_SDA_FILT_OUT_HS_POS        (26u) /* [26]    '0': 50ns filter, '1': 10 ns filter      */
#define SPI_1_I2C_CFG_SDA_FILT_OUT_ENABLED_POS   (27u) /* [27]    I2C SDA output delay filter enabled      */
#define SPI_1_I2C_CFG_SDA_FILT_HYS_MASK          ((uint32) 0x00u)
...
/* SPI_1_TX_CTRL_REG */
#define SPI_1_TX_CTRL_DATA_WIDTH_POS     (0u)  /* [3:0] Dataframe width: (Data width - 1) */
...
#define SPI_1_TX_FIFO_CTRL_CLEAR_POS             (16u) /* [16]  Clear TX FIFO: claared after set           */
#define SPI_1_TX_FIFO_CTRL_FREEZE_POS            (17u) /* [17]  Freeze TX FIFO: HW do not inc read pointer */
#define SPI_1_TX_FIFO_CTRL_TRIGGER_LEVEL_MASK    ((uint32) 0x07u)
...
#define SPI_1_TX_FIFO_STATUS_USED_MASK   ((uint32) 0x0Fu)
#define SPI_1_TX_FIFO_SR_VALID           ((uint32) 0x01u << SPI_1_TX_FIFO_SR_VALID_POS)
#define SPI_1_TX_FIFO_STATUS_RD_PTR_MASK ((uint32) 0x07u << SPI_1_TX_FIFO_STATUS_RD_PTR_POS)
#define SPI_1_TX_FIFO_STATUS_WR_PTR_MASK ((uint32) 0x07u << SPI_1_TX_FIFO_STATUS_WR_PTR_POS)
...
/* SPI_1_RX_CTRL_REG */
#define SPI_1_RX_CTRL_DATA_WIDTH_POS     (0u)  /* [3:0] Dataframe width: (Data width - 1) */
...
#define SPI_1_RX_FIFO_CTRL_CLEAR_POS             (16u)  /* [16]  Clear RX FIFO: claar after set           */
#define SPI_1_RX_FIFO_CTRL_FREEZE_POS            (17u)  /* [17]  Freeze RX FIFO: HW writes has not effect */
#define SPI_1_RX_FIFO_CTRL_TRIGGER_LEVEL_MASK    ((uint32) 0x07u)
...
#define SPI_1_RX_FIFO_STATUS_USED_MASK   ((uint32) 0x0Fu)
#define SPI_1_RX_FIFO_SR_VALID           ((uint32) 0x01u << SPI_1_RX_FIFO_SR_VALID_POS)
#define SPI_1_RX_FIFO_STATUS_RD_PTR_MASK ((uint32) 0x07u << SPI_1_RX_FIFO_STATUS_RD_PTR_POS)
#define SPI_1_RX_FIFO_STATUS_WR_PTR_MASK ((uint32) 0x07u << SPI_1_RX_FIFO_STATUS_WR_PTR_POS)
...
#define SPI_1_INTR_MASTER_SPI_DONE_POS       (9u)  /* [9] Master complete trasfer: Only for SPI            */
...
#define SPI_1_INTR_SLAVE_I2C_STOP_POS             (4u)  /* [4]  Slave detects end of transaction intened */
...
#define SPI_1_INTR_SLAVE_SPI_EZBUF_STOP_POS       (10u) /* [10] Slave end of transaciton: Only for SPI   */
...
#define SPI_1_INTR_RX_BAUD_DETECT_POS    (10u)  /* [10] LIN baudrate detection is completed   */
...
/* Return true if sourceMask is set in SPI_1_CTRL_REG: generaly is used to check enable bit */
...
#define SPI_1_GET_I2C_CTRL_LOW_PHASE_OVS(oversampleLow)   (((uint32) (((uint32) (oversampleLow) - 1u) << \
                                                                    SPI_1_I2C_CTRL_LOW_PHASE_OVS_POS)) &  \
...
#define SPI_1_GET_I2C_CTRL_SL_MSTR_MODE(mode)    ((uint32) ((uint32)(mode) << \
                                                                    SPI_1_I2C_CTRL_SLAVE_MODE_POS))
...
#define SPI_1_GET_SPI_CTRL_SCLK_MODE(mode)       (((uint32) ((uint32) (mode) << \
...
#define SPI_1_GET_SPI_CTRL_SUB_MODE(mode)        (((uint32) (((uint32) (mode)) << \
                                                                        SPI_1_SPI_CTRL_MODE_POS)) & \
                                                                        SPI_1_SPI_CTRL_MODE_MASK)

#define SPI_1_GET_SPI_CTRL_SLAVE_SELECT(select)  (((uint32) ((uint32) (select) << \
                                                                      SPI_1_SPI_CTRL_SLAVE_SELECT_POS)) & \
                                                                      SPI_1_SPI_CTRL_SLAVE_SELECT_MASK)
...
/* SPI_1_UART_CTRL */
#define SPI_1_GET_UART_CTRL_MODE(mode)           (((uint32) ((uint32) (mode) << \
...
#define SPI_1_GET_RX_MATCH_MASK(mask)    (((uint32) ((uint32) (mask) << \
