...
#define SPI_1_sclk_s_DM_ALG_HIZ         (0x00u << SPI_1_sclk_s_DRIVE_MODE_SHIFT)
#define SPI_1_sclk_s_DM_DIG_HIZ         (0x01u << SPI_1_sclk_s_DRIVE_MODE_SHIFT)
#define SPI_1_sclk_s_DM_RES_UP          (0x02u << SPI_1_sclk_s_DRIVE_MODE_SHIFT)
#define SPI_1_sclk_s_DM_RES_DWN         (0x03u << SPI_1_sclk_s_DRIVE_MODE_SHIFT)
#define SPI_1_sclk_s_DM_OD_LO           (0x04u << SPI_1_sclk_s_DRIVE_MODE_SHIFT)
#define SPI_1_sclk_s_DM_OD_HI           (0x05u << SPI_1_sclk_s_DRIVE_MODE_SHIFT)
#define SPI_1_sclk_s_DM_STRONG          (0x06u << SPI_1_sclk_s_DRIVE_MODE_SHIFT)
#define SPI_1_sclk_s_DM_RES_UPDWN       (0x07u << SPI_1_sclk_s_DRIVE_MODE_SHIFT)
