...
#define SPI_1_SPI_BTLDR_COMM_ENABLED   ((CYDEV_BOOTLOADER_IO_COMP == CyBtldr_SPI_1) || \
                                                    (CYDEV_BOOTLOADER_IO_COMP == CyBtldr_Custom_Interface))

#define SPI_1_UART_BTLDR_COMM_ENABLED   ((CYDEV_BOOTLOADER_IO_COMP == CyBtldr_SPI_1) || \
                                                    (CYDEV_BOOTLOADER_IO_COMP == CyBtldr_Custom_Interface))
...
/* SPI master active slave select constants for SPI_1_SpiSetActiveSlaveSelect() */
#define SPI_1_SPIM_ACTIVE_SS0    (0x00u)
#define SPI_1_SPIM_ACTIVE_SS1    (0x01u)
#define SPI_1_SPIM_ACTIVE_SS2    (0x02u)
#define SPI_1_SPIM_ACTIVE_SS3    (0x03u)
