...
#else
    #define SPIS_1_SCB_PINS_NUMBER    (2u)
...
#define SPIS_1_MOSI_SCL_RX_PIN_MASK      ((uint32) 0x01u << SPIS_1_MOSI_SCL_RX_PIN_INDEX)
#define SPIS_1_MOSI_SCL_RX_WAKE_PIN_MASK ((uint32) 0x01u << SPIS_1_MOSI_SCL_RX_WAKE_PIN_INDEX)
#define SPIS_1_MISO_SDA_TX_PIN_MASK      ((uint32) 0x01u << SPIS_1_MISO_SDA_TX_PIN_INDEX)
#define SPIS_1_SCLK_PIN_MASK             ((uint32) 0x01u << SPIS_1_SCLK_PIN_INDEX)
#define SPIS_1_SS0_PIN_MASK              ((uint32) 0x01u << SPIS_1_SS0_PIN_INDEX)
#define SPIS_1_SS1_PIN_MASK              ((uint32) 0x01u << SPIS_1_SS1_PIN_INDEX)
#define SPIS_1_SS2_PIN_MASK              ((uint32) 0x01u << SPIS_1_SS2_PIN_INDEX)
#define SPIS_1_SS3_PIN_MASK              ((uint32) 0x01u << SPIS_1_SS3_PIN_INDEX)
...
#define SPIS_1_SET_REGISTER_BIT(reg, mask, val) \
...
#define SPIS_1_SET_INP_DIS(reg, mask, val) SPIS_1_SET_REGISTER_BIT(reg, mask, val)
...
/* SCB I2C: scl signal */
    ...
    #define SPIS_1_SET_I2C_SCL_HSIOM_SEL(sel) \
                          SPIS_1_SET_HSIOM_SEL(SPIS_1_SCL_HSIOM_REG,  \
                                                         ...
                                                         (sel))
    #define SPIS_1_WAIT_SCL_SET_HIGH  (0u == SPIS_1_scl_Read())

/* Unconfigured SCB: scl signal */
#elif(SPIS_1_MOSI_SCL_RX_WAKE_PIN)
    ...
    #define SPIS_1_WAIT_SCL_SET_HIGH  (0u == SPIS_1_spi_mosi_i2c_scl_uart_rx_wake_Read())
    ...
    #define SPIS_1_WAIT_SCL_SET_HIGH  (0u == SPIS_1_spi_mosi_i2c_scl_uart_rx_Read())
    ...
    #define SPIS_1_WAIT_SCL_SET_HIGH  (0u)
#endif /* (SPIS_1_MOSI_SCL_RX_PIN) */

/* SCB I2C: sda signal */
#if(SPIS_1_I2C_PINS)
    #define SPIS_1_WAIT_SDA_SET_HIGH  (0u == SPIS_1_sda_Read())

/* Unconfigured SCB: sda signal */
#elif(SPIS_1_MISO_SDA_TX_PIN)
    #define SPIS_1_WAIT_SDA_SET_HIGH  (0u == SPIS_1_spi_miso_i2c_sda_uart_tx_Read())

#else
    #define SPIS_1_WAIT_SDA_SET_HIGH  (0u)
#endif /* (SPIS_1_MOSI_SCL_RX_PIN) */
