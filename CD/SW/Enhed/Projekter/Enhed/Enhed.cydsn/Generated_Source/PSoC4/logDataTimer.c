...
uint8 logDataTimer_initVar = 0u;


/*******************************************************************************
* Function Name: logDataTimer_Init
********************************************************************************
*
* Summary:
...
void logDataTimer_Init(void) 
{
        ...
        #if (CY_PSOC5A)
            logDataTimer_CONTROL2 &= ((uint8)(~logDataTimer_CTRL_MODE_MASK));
        #endif /* Clear bits in CONTROL2 only in PSOC5A */

        #if (CY_PSOC3 || CY_PSOC5LP)
            logDataTimer_CONTROL3 &= ((uint8)(~logDataTimer_CTRL_MODE_MASK));
        #endif /* CONTROL3 register exists only in PSoC3 OR PSoC5LP */

        /* Check if One Shot mode is enabled i.e. RunMode !=0*/
        #if (logDataTimer_RunModeUsed != 0x0u)
            /* Set 3rd bit of Control register to enable one shot mode */
            logDataTimer_CONTROL |= 0x04u;
        #endif /* One Shot enabled only when RunModeUsed is not Continuous*/

        #if (logDataTimer_RunModeUsed == 2)
            #if (CY_PSOC5A)
                /* Set last 2 bits of control2 register if one shot(halt on
                interrupt) is enabled*/
                logDataTimer_CONTROL2 |= 0x03u;
            #endif /* Set One-Shot Halt on Interrupt bit in CONTROL2 for PSoC5A */

            #if (CY_PSOC3 || CY_PSOC5LP)
                /* Set last 2 bits of control3 register if one shot(halt on
                interrupt) is enabled*/
                logDataTimer_CONTROL3 |= 0x03u;
            #endif /* Set One-Shot Halt on Interrupt bit in CONTROL3 for PSoC3 or PSoC5LP */

        #endif /* Remove section if One Shot Halt on Interrupt is not enabled */

        #if (logDataTimer_UsingHWEnable != 0)
            #if (CY_PSOC5A)
                /* Set the default Run Mode of the Timer to Continuous */
                logDataTimer_CONTROL2 |= logDataTimer_CTRL_MODE_PULSEWIDTH;
            #endif /* Set Continuous Run Mode in CONTROL2 for PSoC5A */

            #if (CY_PSOC3 || CY_PSOC5LP)
                /* Clear and Set ROD and COD bits of CFG2 register */
                logDataTimer_CONTROL3 &= ((uint8)(~logDataTimer_CTRL_RCOD_MASK));
                logDataTimer_CONTROL3 |= logDataTimer_CTRL_RCOD;

                /* Clear and Enable the HW enable bit in CFG2 register */
                logDataTimer_CONTROL3 &= ((uint8)(~logDataTimer_CTRL_ENBL_MASK));
                logDataTimer_CONTROL3 |= logDataTimer_CTRL_ENBL;

                /* Set the default Run Mode of the Timer to Continuous */
                logDataTimer_CONTROL3 |= logDataTimer_CTRL_MODE_CONTINUOUS;
            #endif /* Set Continuous Run Mode in CONTROL3 for PSoC3ES3 or PSoC5A */

        #endif /* Configure Run Mode with hardware enable */

        /* Clear and Set SYNCTC and SYNCCMP bits of RT1 register */
        logDataTimer_RT1 &= ((uint8)(~logDataTimer_RT1_MASK));
        logDataTimer_RT1 |= logDataTimer_SYNC;

        /*Enable DSI Sync all all inputs of the Timer*/
        logDataTimer_RT1 &= ((uint8)(~logDataTimer_SYNCDSI_MASK));
        logDataTimer_RT1 |= logDataTimer_SYNCDSI_EN;

        /* Set the IRQ to use the status register interrupts */
        logDataTimer_CONTROL2 |= logDataTimer_CTRL2_IRQ_SEL;
    #endif /* Configuring registers of fixed function implementation */

    /* Set Initial values from Configuration */
    logDataTimer_WritePeriod(logDataTimer_INIT_PERIOD);
    logDataTimer_WriteCounter(logDataTimer_INIT_PERIOD);

    #if (logDataTimer_UsingHWCaptureCounter)/* Capture counter is enabled */
        logDataTimer_CAPTURE_COUNT_CTRL |= logDataTimer_CNTR_ENABLE;
        logDataTimer_SetCaptureCount(logDataTimer_INIT_CAPTURE_COUNT);
    #endif /* Configure capture counter value */

    #if (!logDataTimer_UsingFixedFunction)
        #if (logDataTimer_SoftwareCaptureMode)
            logDataTimer_SetCaptureMode(logDataTimer_INIT_CAPTURE_MODE);
    ...
    logDataTimer_SetInterruptMode(logDataTimer_INIT_INTERRUPT_MODE);
}


/*******************************************************************************
* Function Name: logDataTimer_Enable
********************************************************************************
*
* Summary:
*  Enable the Timer
...
void logDataTimer_Enable(void) 
{
    ...
    #if (logDataTimer_UsingFixedFunction)
        logDataTimer_GLOBAL_ENABLE |= logDataTimer_BLOCK_EN_MASK;
        logDataTimer_GLOBAL_STBY_ENABLE |= logDataTimer_BLOCK_STBY_EN_MASK;
...
/*******************************************************************************
* Function Name: logDataTimer_Start
********************************************************************************
*
* Summary:
...
*
* Global variables:
*  logDataTimer_initVar: Is modified when this function is called for the
*   first time. Is used to ensure that initialization happens only once.
*
*******************************************************************************/
void logDataTimer_Start(void) 
{
    if(logDataTimer_initVar == 0u)
    {
        logDataTimer_Init();

        logDataTimer_initVar = 1u;   /* Clear this bit for Initialization */
    }
...
/*******************************************************************************
* Function Name: logDataTimer_Stop
********************************************************************************
*
* Summary:
...
void logDataTimer_Stop(void) 
{
    ...
    #if (logDataTimer_UsingFixedFunction)
        logDataTimer_GLOBAL_ENABLE &= ((uint8)(~logDataTimer_BLOCK_EN_MASK));
        logDataTimer_GLOBAL_STBY_ENABLE &= ((uint8)(~logDataTimer_BLOCK_STBY_EN_MASK));
    #endif /* Disable global enable for the Timer Fixed function block to stop the Timer*/
}


/*******************************************************************************
* Function Name: logDataTimer_SetInterruptMode
********************************************************************************
*
* Summary:
...
{
    logDataTimer_STATUS_MASK = interruptMode;
}


/*******************************************************************************
* Function Name: logDataTimer_SoftwareCapture
********************************************************************************
*
* Summary:
...
/*******************************************************************************
* Function Name: logDataTimer_ReadStatusRegister
********************************************************************************
*
* Summary:
...
/*******************************************************************************
* Function Name: logDataTimer_ReadControlRegister
********************************************************************************
*
* Summary:
...
/*******************************************************************************
* Function Name: logDataTimer_WriteControlRegister
********************************************************************************
*
* Summary:
...
/*******************************************************************************
* Function Name: logDataTimer_ReadPeriod
********************************************************************************
*
* Summary:
...
/*******************************************************************************
* Function Name: logDataTimer_WritePeriod
********************************************************************************
*
* Summary:
...
/*******************************************************************************
* Function Name: logDataTimer_ReadCapture
********************************************************************************
*
* Summary:
...
/*******************************************************************************
* Function Name: logDataTimer_WriteCounter
********************************************************************************
*
* Summary:
...
/*******************************************************************************
* Function Name: logDataTimer_ReadCounter
********************************************************************************
*
* Summary:
...
/*******************************************************************************
* Function Name: logDataTimer_SetCaptureMode
********************************************************************************
*
* Summary:
...
*  logDataTimer__B_TIMER__CM_NONE        - Set Capture mode to None
*  logDataTimer__B_TIMER__CM_RISINGEDGE  - Rising edge of Capture input
*  logDataTimer__B_TIMER__CM_FALLINGEDGE - Falling edge of Capture input
*  logDataTimer__B_TIMER__CM_EITHEREDGE  - Either edge of Capture input
*
* Return:
*  void
*
...
/*******************************************************************************
* Function Name: logDataTimer_SetTriggerMode
********************************************************************************
*
* Summary:
...
/*******************************************************************************
* Function Name: logDataTimer_EnableTrigger
********************************************************************************
*
* Summary:
...
/*******************************************************************************
* Function Name: logDataTimer_DisableTrigger
********************************************************************************
*
* Summary:
...
/*******************************************************************************
* Function Name: logDataTimer_SetInterruptCount
********************************************************************************
*
* Summary:
...
/*******************************************************************************
* Function Name: logDataTimer_SetCaptureCount
********************************************************************************
*
* Summary:
...
{
    logDataTimer_CAP_COUNT = captureCount;
}


/*******************************************************************************
* Function Name: logDataTimer_ReadCaptureCount
********************************************************************************
*
* Summary:
...
{
    return ((uint8)logDataTimer_CAP_COUNT);
}
#endif /* logDataTimer_UsingHWCaptureCounter */


/*******************************************************************************
* Function Name: logDataTimer_ClearFIFO
********************************************************************************
*
* Summary:
...
{
    while(0u != (logDataTimer_ReadStatusRegister() & logDataTimer_STATUS_FIFONEMP))
    {
        (void)logDataTimer_ReadCapture();
    }
}
