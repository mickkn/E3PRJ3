...
#define GREEN_LED_DM_ALG_HIZ         (0x00u << GREEN_LED_DRIVE_MODE_SHIFT)
#define GREEN_LED_DM_DIG_HIZ         (0x01u << GREEN_LED_DRIVE_MODE_SHIFT)
#define GREEN_LED_DM_RES_UP          (0x02u << GREEN_LED_DRIVE_MODE_SHIFT)
#define GREEN_LED_DM_RES_DWN         (0x03u << GREEN_LED_DRIVE_MODE_SHIFT)
#define GREEN_LED_DM_OD_LO           (0x04u << GREEN_LED_DRIVE_MODE_SHIFT)
#define GREEN_LED_DM_OD_HI           (0x05u << GREEN_LED_DRIVE_MODE_SHIFT)
#define GREEN_LED_DM_STRONG          (0x06u << GREEN_LED_DRIVE_MODE_SHIFT)
#define GREEN_LED_DM_RES_UPDWN       (0x07u << GREEN_LED_DRIVE_MODE_SHIFT)
