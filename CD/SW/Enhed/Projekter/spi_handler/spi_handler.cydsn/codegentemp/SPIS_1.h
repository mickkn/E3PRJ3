...
#define SPIS_1_CY_SCBIP_V0 (CYIPBLOCK_m0s8scb_VERSION == 0u)
#define SPIS_1_CY_SCBIP_V1 (CYIPBLOCK_m0s8scb_VERSION >= 1u)

#if(SPIS_1_CY_SCBIP_V1)
    #define SPIS_1_CY_SCBIP_V1_I2C_ONLY   (1u) /* SCB IP V1 supports only I2C */
#else
    #define SPIS_1_CY_SCBIP_V1_I2C_ONLY   (0u) /* SCB IP V0 supports I2C, SPI, UART */
#endif /* (SPIS_1_CY_SCBIP_V1) */
...
#else
#define SPIS_1_SCB_MODE_SPI_INC       (0u)
#define SPIS_1_SCB_MODE_UART_INC      (0u)
...
/* Interface to internal interrupt component */
    ...
    #define SPIS_1_EnableInt()        CyIntEnable      (SPIS_1_ISR_NUMBER)
    #define SPIS_1_DisableInt()       CyIntDisable     (SPIS_1_ISR_NUMBER)
    #define SPIS_1_ClearPendingInt()  CyIntClearPending(SPIS_1_ISR_NUMBER)
#endif /* (SPIS_1_SCB_IRQ_INTERNAL) */

#if(SPIS_1_UART_RX_WAKEUP_IRQ)
    #define SPIS_1_RxWakeEnableInt()        CyIntEnable      (SPIS_1_RX_WAKE_ISR_NUMBER)
    #define SPIS_1_RxWakeDisableInt()       CyIntDisable     (SPIS_1_RX_WAKE_ISR_NUMBER)
    #define SPIS_1_RxWakeClearPendingInt()  CyIntClearPending(SPIS_1_RX_WAKE_ISR_NUMBER)
...
#if(SPIS_1_SCB_IRQ_INTERNAL)
    #define SPIS_1_ISR_NUMBER     ((uint8) SPIS_1_SCB_IRQ__INTC_NUMBER)
    #define SPIS_1_ISR_PRIORITY   ((uint8) SPIS_1_SCB_IRQ__INTC_PRIOR_NUM)
#endif /* (SPIS_1_SCB_IRQ_INTERNAL) */

#if(SPIS_1_UART_RX_WAKEUP_IRQ)
    #define SPIS_1_RX_WAKE_ISR_NUMBER     ((uint8) SPIS_1_RX_WAKEUP_IRQ__INTC_NUMBER)
    #define SPIS_1_RX_WAKE_ISR_PRIORITY   ((uint8) SPIS_1_RX_WAKEUP_IRQ__INTC_PRIOR_NUM)
#endif /* (SPIS_1_UART_RX_WAKEUP_IRQ) */
...
#define SPIS_1_CTRL_EC_AM_MODE        ((uint32) 0x01u << SPIS_1_CTRL_EC_AM_MODE_POS)
#define SPIS_1_CTRL_EC_OP_MODE        ((uint32) 0x01u << SPIS_1_CTRL_EC_OP_MODE_POS)
#define SPIS_1_CTRL_EZBUF_MODE        ((uint32) 0x01u << SPIS_1_CTRL_EZBUF_MODE_POS)
#define SPIS_1_CTRL_ADDR_ACCEPT       ((uint32) 0x01u << SPIS_1_CTRL_ADDR_ACCEPT_POS)
#define SPIS_1_CTRL_BLOCK             ((uint32) 0x01u << SPIS_1_CTRL_BLOCK_POS)
#define SPIS_1_CTRL_MODE_MASK         ((uint32) 0x03u << SPIS_1_CTRL_MODE_POS)
#define SPIS_1_CTRL_MODE_I2C          ((uint32) 0x00u)
#define SPIS_1_CTRL_MODE_SPI          ((uint32) 0x01u << SPIS_1_CTRL_MODE_POS)
#define SPIS_1_CTRL_MODE_UART         ((uint32) 0x02u << SPIS_1_CTRL_MODE_POS)
#define SPIS_1_CTRL_ENABLED           ((uint32) 0x01u << SPIS_1_CTRL_ENABLED_POS)
...
#define SPIS_1_SPI_CTRL_SELECT_PRECEDE        ((uint32) 0x01u << SPIS_1_SPI_CTRL_SELECT_PRECEDE_POS)
#define SPIS_1_SPI_CTRL_SCLK_MODE_MASK        ((uint32) 0x03u << SPIS_1_SPI_CTRL_CPHA_POS)
#define SPIS_1_SPI_CTRL_CPHA                  ((uint32) 0x01u << SPIS_1_SPI_CTRL_CPHA_POS)
#define SPIS_1_SPI_CTRL_CPOL                  ((uint32) 0x01u << SPIS_1_SPI_CTRL_CPOL_POS)
#define SPIS_1_SPI_CTRL_LATE_MISO_SAMPLE      ((uint32) 0x01u << \
                                                                    SPIS_1_SPI_CTRL_LATE_MISO_SAMPLE_POS)
#define SPIS_1_SPI_CTRL_LOOPBACK              ((uint32) 0x01u << SPIS_1_SPI_CTRL_LOOPBACK_POS)
#define SPIS_1_SPI_CTRL_MODE_MASK             ((uint32) 0x03u << SPIS_1_SPI_CTRL_MODE_POS)
#define SPIS_1_SPI_CTRL_MODE_MOTOROLA         ((uint32) 0x00u)
#define SPIS_1_SPI_CTRL_MODE_TI               ((uint32) 0x01u << SPIS_1_CTRL_MODE_POS)
#define SPIS_1_SPI_CTRL_MODE_NS               ((uint32) 0x02u << SPIS_1_CTRL_MODE_POS)
#define SPIS_1_SPI_CTRL_SLAVE_SELECT_MASK     ((uint32) 0x03u << SPIS_1_SPI_CTRL_SLAVE_SELECT_POS)
#define SPIS_1_SPI_CTRL_SLAVE_SELECT0         ((uint32) 0x00u)
#define SPIS_1_SPI_CTRL_SLAVE_SELECT1         ((uint32) 0x01u << SPIS_1_SPI_CTRL_SLAVE_SELECT_POS)
#define SPIS_1_SPI_CTRL_SLAVE_SELECT2         ((uint32) 0x02u << SPIS_1_SPI_CTRL_SLAVE_SELECT_POS)
#define SPIS_1_SPI_CTRL_SLAVE_SELECT3         ((uint32) 0x03u << SPIS_1_SPI_CTRL_SLAVE_SELECT_POS)
#define SPIS_1_SPI_CTRL_MASTER                ((uint32) 0x01u << SPIS_1_SPI_CTRL_MASTER_MODE_POS)
...
#define SPIS_1_SPI_STATUS_EZBUF_ADDR_MASK ((uint32) 0xFFu << SPIS_1_I2C_STATUS_EZBUF_ADDR_POS)

/* SPIS_1_UART_CTRL */
#define SPIS_1_UART_CTRL_LOOPBACK_POS         (16u) /* [16] Loopback     */
#define SPIS_1_UART_CTRL_MODE_POS             (24u) /* [24] UART subMode */
#define SPIS_1_UART_CTRL_LOOPBACK             ((uint32) 0x01u << SPIS_1_UART_CTRL_LOOPBACK_POS)
#define SPIS_1_UART_CTRL_MODE_UART_STD        ((uint32) 0x00u)
#define SPIS_1_UART_CTRL_MODE_UART_SMARTCARD  ((uint32) 0x01u << SPIS_1_UART_CTRL_MODE_POS)
#define SPIS_1_UART_CTRL_MODE_UART_IRDA       ((uint32) 0x02u << SPIS_1_UART_CTRL_MODE_POS)
#define SPIS_1_UART_CTRL_MODE_MASK            ((uint32) 0x03u << SPIS_1_UART_CTRL_MODE_POS)
...
#define SPIS_1_UART_TX_CTRL_PARITY                ((uint32) 0x01u << \
                                                                    SPIS_1_UART_TX_CTRL_PARITY_POS)
#define SPIS_1_UART_TX_CTRL_PARITY_ENABLED        ((uint32) 0x01u << \
                                                                    SPIS_1_UART_TX_CTRL_PARITY_ENABLED_POS)
#define SPIS_1_UART_TX_CTRL_RETRY_ON_NACK         ((uint32) 0x01u << \
...
#define SPIS_1_UART_RX_CTRL_PARITY                    ((uint32) 0x01u << \
                                                                    SPIS_1_UART_RX_CTRL_PARITY_POS)
#define SPIS_1_UART_RX_CTRL_PARITY_ENABLED            ((uint32) 0x01u << \
                                                                    SPIS_1_UART_RX_CTRL_PARITY_ENABLED_POS)
#define SPIS_1_UART_RX_CTRL_POLARITY                  ((uint32) 0x01u << \
                                                                    SPIS_1_UART_RX_CTRL_POLARITY_POS)
#define SPIS_1_UART_RX_CTRL_DROP_ON_PARITY_ERR        ((uint32) 0x01u << \
                                                                   SPIS_1_UART_RX_CTRL_DROP_ON_PARITY_ERR_POS)
#define SPIS_1_UART_RX_CTRL_DROP_ON_FRAME_ERR         ((uint32) 0x01u << \
                                                                    SPIS_1_UART_RX_CTRL_DROP_ON_FRAME_ERR_POS)
#define SPIS_1_UART_RX_CTRL_MP_MODE                   ((uint32) 0x01u << \
                                                                    SPIS_1_UART_RX_CTRL_MP_MODE_POS)
#define SPIS_1_UART_RX_CTRL_LIN_MODE                  ((uint32) 0x01u << \
                                                                    SPIS_1_UART_RX_CTRL_LIN_MODE_POS)
#define SPIS_1_UART_RX_CTRL_SKIP_START                ((uint32) 0x01u << \
                                                                    SPIS_1_UART_RX_CTRL_SKIP_START_POS)
#define SPIS_1_UART_RX_CTRL_BREAK_WIDTH_MASK          ((uint32) 0x0Fu << \
...
#define SPIS_1_I2C_CTRL_LOW_PHASE_OVS_MASK   ((uint32) 0x0Fu << \
                                                                SPIS_1_I2C_CTRL_LOW_PHASE_OVS_POS)
#define SPIS_1_I2C_CTRL_M_READY_DATA_ACK      ((uint32) 0x01u << \
                                                                SPIS_1_I2C_CTRL_M_READY_DATA_ACK_POS)
#define SPIS_1_I2C_CTRL_M_NOT_READY_DATA_NACK ((uint32) 0x01u << \
                                                                SPIS_1_I2C_CTRL_M_NOT_READY_DATA_NACK_POS)
#define SPIS_1_I2C_CTRL_S_GENERAL_IGNORE      ((uint32) 0x01u << \
                                                                SPIS_1_I2C_CTRL_S_GENERAL_IGNORE_POS)
#define SPIS_1_I2C_CTRL_S_READY_ADDR_ACK      ((uint32) 0x01u << \
                                                                SPIS_1_I2C_CTRL_S_READY_ADDR_ACK_POS)
#define SPIS_1_I2C_CTRL_S_READY_DATA_ACK      ((uint32) 0x01u << \
                                                                SPIS_1_I2C_CTRL_S_READY_DATA_ACK_POS)
#define SPIS_1_I2C_CTRL_S_NOT_READY_ADDR_NACK ((uint32) 0x01u << \
                                                                SPIS_1_I2C_CTRL_S_NOT_READY_ADDR_NACK_POS)
#define SPIS_1_I2C_CTRL_S_NOT_READY_DATA_NACK ((uint32) 0x01u << \
                                                                SPIS_1_I2C_CTRL_S_NOT_READY_DATA_NACK_POS)
#define SPIS_1_I2C_CTRL_LOOPBACK              ((uint32) 0x01u << \
                                                                SPIS_1_I2C_CTRL_LOOPBACK_POS)
#define SPIS_1_I2C_CTRL_SLAVE_MODE            ((uint32) 0x01u << \
                                                                SPIS_1_I2C_CTRL_SLAVE_MODE_POS)
#define SPIS_1_I2C_CTRL_MASTER_MODE           ((uint32) 0x01u << \
                                                                SPIS_1_I2C_CTRL_MASTER_MODE_POS)
#define SPIS_1_I2C_CTRL_SLAVE_MASTER_MODE_MASK    ((uint32) 0x03u << \
                                                                SPIS_1_I2C_CTRL_SLAVE_MODE_POS)
...
#define SPIS_1_I2C_STATUS_S_READ          ((uint32) 0x01u << SPIS_1_I2C_STATUS_S_READ_POS)
#define SPIS_1_I2C_STATUS_M_READ          ((uint32) 0x01u << SPIS_1_I2C_STATUS_M_READ_POS)
#define SPIS_1_I2C_STATUS_EZBUF_ADDR_MASK ((uint32) 0xFFu << SPIS_1_I2C_STATUS_EZBUF_ADDR_POS)
...
#define SPIS_1_I2C_MASTER_CMD_M_START_ON_IDLE ((uint32) 0x01u << \
                                                                   SPIS_1_I2C_MASTER_CMD_M_START_ON_IDLE_POS)
#define SPIS_1_I2C_MASTER_CMD_M_ACK           ((uint32) 0x01u << \
                                                                   SPIS_1_I2C_MASTER_CMD_M_ACK_POS)
#define SPIS_1_I2C_MASTER_CMD_M_NACK          ((uint32) 0x01u << \
                                                                    SPIS_1_I2C_MASTER_CMD_M_NACK_POS)
#define SPIS_1_I2C_MASTER_CMD_M_STOP          ((uint32) 0x01u << \
...
#define SPIS_1_I2C_SLAVE_CMD_S_NACK       ((uint32) 0x01u << SPIS_1_I2C_SLAVE_CMD_S_NACK_POS)
...
#define SPIS_1_I2C_CFG_SDA_FILT_TRIM_MASK         ((uint32) 0x03u << \
                                                                SPIS_1_I2C_CFG_SDA_FILT_TRIM_POS)
#define SPIS_1_I2C_CFG_SCL_FILT_HYS_MASK          ((uint32) 0x03u << \
                                                                SPIS_1_I2C_CFG_SCL_FILT_HYS_POS)
#define SPIS_1_I2C_CFG_SCL_FILT_TRIM_MASK         ((uint32) 0x03u << \
                                                                SPIS_1_I2C_CFG_SCL_FILT_TRIM_POS)
#define SPIS_1_I2C_CFG_SDA_FILT_OUT_HYS_MASK      ((uint32) 0x03u << \
                                                                SPIS_1_I2C_CFG_SDA_FILT_OUT_HYS_POS)
#define SPIS_1_I2C_CFG_SDA_FILT_OUT_TRIM_MASK     ((uint32) 0x03u << \
                                                                SPIS_1_I2C_CFG_SDA_FILT_OUT_TRIM_POS)
#define SPIS_1_I2C_CFG_SDA_FILT_HS                ((uint32) 0x01u << \
                                                                SPIS_1_I2C_CFG_SDA_FILT_HS_POS)
#define SPIS_1_I2C_CFG_SDA_FILT_ENABLED           ((uint32) 0x01u << \
                                                                SPIS_1_I2C_CFG_SDA_FILT_ENABLED_POS)
#define SPIS_1_I2C_CFG_SCL_FILT_HS                ((uint32) 0x01u << \
                                                                SPIS_1_I2C_CFG_SCL_FILT_HS_POS)
#define SPIS_1_I2C_CFG_SCL_FILT_ENABLED           ((uint32) 0x01u << \
                                                                SPIS_1_I2C_CFG_SCL_FILT_ENABLED_POS)
#define SPIS_1_I2C_CFG_SDA_FILT_OUT_HS            ((uint32) 0x01u << \
                                                                SPIS_1_I2C_CFG_SDA_FILT_OUT_HS_POS)
#define SPIS_1_I2C_CFG_SDA_FILT_OUT_ENABLED       ((uint32) 0x01u << \
...
#define SPIS_1_TX_CTRL_MSB_FIRST          ((uint32) 0x01u << SPIS_1_TX_CTRL_MSB_FIRST_POS)
#define SPIS_1_TX_CTRL_LSB_FIRST          ((uint32) 0x00u)
#define SPIS_1_TX_CTRL_ENABLED            ((uint32) 0x01u << SPIS_1_TX_CTRL_ENABLED_POS)
...
#define SPIS_1_TX_FIFO_CTRL_CLEAR                 ((uint32) 0x01u << SPIS_1_TX_FIFO_CTRL_CLEAR_POS)
#define SPIS_1_TX_FIFO_CTRL_FREEZE                ((uint32) 0x01u << SPIS_1_TX_FIFO_CTRL_FREEZE_POS)
...
#define SPIS_1_TX_FIFO_SR_VALID           ((uint32) 0x01u << SPIS_1_TX_FIFO_SR_VALID_POS)
#define SPIS_1_TX_FIFO_STATUS_RD_PTR_MASK ((uint32) 0x07u << SPIS_1_TX_FIFO_STATUS_RD_PTR_POS)
#define SPIS_1_TX_FIFO_STATUS_WR_PTR_MASK ((uint32) 0x07u << SPIS_1_TX_FIFO_STATUS_WR_PTR_POS)
...
#define SPIS_1_RX_CTRL_MSB_FIRST          ((uint32) 0x01u << SPIS_1_RX_CTRL_MSB_FIRST_POS)
#define SPIS_1_RX_CTRL_LSB_FIRST          ((uint32) 0x00u)
#define SPIS_1_RX_CTRL_MEDIAN             ((uint32) 0x01u << SPIS_1_RX_CTRL_MEDIAN_POS)
#define SPIS_1_RX_CTRL_ENABLED            ((uint32) 0x01u << SPIS_1_RX_CTRL_ENABLED_POS)
...
#define SPIS_1_RX_FIFO_CTRL_CLEAR                 ((uint32) 0x01u << SPIS_1_RX_FIFO_CTRL_CLEAR_POS)
#define SPIS_1_RX_FIFO_CTRL_FREEZE                ((uint32) 0x01u << SPIS_1_RX_FIFO_CTRL_FREEZE_POS)
...
#define SPIS_1_RX_FIFO_SR_VALID           ((uint32) 0x01u << SPIS_1_RX_FIFO_SR_VALID_POS)
#define SPIS_1_RX_FIFO_STATUS_RD_PTR_MASK ((uint32) 0x07u << SPIS_1_RX_FIFO_STATUS_RD_PTR_POS)
#define SPIS_1_RX_FIFO_STATUS_WR_PTR_MASK ((uint32) 0x07u << SPIS_1_RX_FIFO_STATUS_WR_PTR_POS)
...
#define SPIS_1_RX_MATCH_MASK_MASK    ((uint32) 0xFFu << SPIS_1_RX_MATCH_MASK_POS)
...
#define SPIS_1_INTR_CAUSE_SLAVE       ((uint32) 0x01u << SPIS_1_INTR_CAUSE_SLAVE_POS)
#define SPIS_1_INTR_CAUSE_TX          ((uint32) 0x01u << SPIS_1_INTR_CAUSE_TX_POS)
#define SPIS_1_INTR_CAUSE_RX          ((uint32) 0x01u << SPIS_1_INTR_CAUSE_RX_POS)
#define SPIS_1_INTR_CAUSE_I2C_EC      ((uint32) 0x01u << SPIS_1_INTR_CAUSE_I2C_EC_POS)
#define SPIS_1_INTR_CAUSE_SPI_EC      ((uint32) 0x01u << SPIS_1_INTR_CAUSE_SPI_EC_POS)
...
#define SPIS_1_INTR_SPI_EC_EZBUF_STOP           ((uint32) 0x01u << \
                                                                    SPIS_1_INTR_SPI_EC_EZBUF_STOP_POS)
#define SPIS_1_INTR_SPI_EC_EZBUF_WRITE_STOP     ((uint32) 0x01u << \
...
#define SPIS_1_INTR_I2C_EC_EZBUF_STOP           ((uint32) 0x01u << \
                                                                    SPIS_1_INTR_I2C_EC_EZBUF_STOP_POS)
#define SPIS_1_INTR_I2C_EC_EZBUF_WRITE_STOP     ((uint32) 0x01u << \
...
#define SPIS_1_INTR_MASTER_I2C_NACK           ((uint32) 0x01u << SPIS_1_INTR_MASTER_I2C_NACK_POS)
#define SPIS_1_INTR_MASTER_I2C_ACK            ((uint32) 0x01u << SPIS_1_INTR_MASTER_I2C_ACK_POS)
#define SPIS_1_INTR_MASTER_I2C_STOP           ((uint32) 0x01u << SPIS_1_INTR_MASTER_I2C_STOP_POS)
#define SPIS_1_INTR_MASTER_I2C_BUS_ERROR      ((uint32) 0x01u << \
                                                                    SPIS_1_INTR_MASTER_I2C_BUS_ERROR_POS)
#define SPIS_1_INTR_MASTER_SPI_DONE           ((uint32) 0x01u << SPIS_1_INTR_MASTER_SPI_DONE_POS)
...
#define SPIS_1_INTR_SLAVE_I2C_NACK                 ((uint32) 0x01u << \
                                                                    SPIS_1_INTR_SLAVE_I2C_NACK_POS)
#define SPIS_1_INTR_SLAVE_I2C_ACK                  ((uint32) 0x01u << \
                                                                    SPIS_1_INTR_SLAVE_I2C_ACK_POS)
#define SPIS_1_INTR_SLAVE_I2C_WRITE_STOP           ((uint32) 0x01u << \
                                                                    SPIS_1_INTR_SLAVE_I2C_WRITE_STOP_POS)
#define SPIS_1_INTR_SLAVE_I2C_STOP                 ((uint32) 0x01u << \
                                                                    SPIS_1_INTR_SLAVE_I2C_STOP_POS)
#define SPIS_1_INTR_SLAVE_I2C_START                ((uint32) 0x01u << \
                                                                    SPIS_1_INTR_SLAVE_I2C_START_POS)
#define SPIS_1_INTR_SLAVE_I2C_ADDR_MATCH           ((uint32) 0x01u << \
                                                                    SPIS_1_INTR_SLAVE_I2C_ADDR_MATCH_POS)
#define SPIS_1_INTR_SLAVE_I2C_GENERAL              ((uint32) 0x01u << \
                                                                    SPIS_1_INTR_SLAVE_I2C_GENERAL_POS)
#define SPIS_1_INTR_SLAVE_I2C_BUS_ERROR            ((uint32) 0x01u << \
                                                                    SPIS_1_INTR_SLAVE_I2C_BUS_ERROR_POS)
#define SPIS_1_INTR_SLAVE_SPI_EZBUF_WRITE_STOP     ((uint32) 0x01u << \
                                                                   SPIS_1_INTR_SLAVE_SPI_EZBUF_WRITE_STOP_POS)
#define SPIS_1_INTR_SLAVE_SPI_EZBUF_STOP           ((uint32) 0x01u << \
                                                                    SPIS_1_INTR_SLAVE_SPI_EZBUF_STOP_POS)
#define SPIS_1_INTR_SLAVE_SPI_BUS_ERROR           ((uint32) 0x01u << \
...
#define SPIS_1_INTR_TX_NOT_FULL           ((uint32) 0x01u << SPIS_1_INTR_TX_NOT_FULL_POS)
#define SPIS_1_INTR_TX_EMPTY              ((uint32) 0x01u << SPIS_1_INTR_TX_EMPTY_POS)
#define SPIS_1_INTR_TX_OVERFLOW           ((uint32) 0x01u << SPIS_1_INTR_TX_OVERFLOW_POS)
#define SPIS_1_INTR_TX_UNDERFLOW          ((uint32) 0x01u << SPIS_1_INTR_TX_UNDERFLOW_POS)
#define SPIS_1_INTR_TX_BLOCKED            ((uint32) 0x01u << SPIS_1_INTR_TX_BLOCKED_POS)
#define SPIS_1_INTR_TX_UART_NACK          ((uint32) 0x01u << SPIS_1_INTR_TX_UART_NACK_POS)
#define SPIS_1_INTR_TX_UART_DONE          ((uint32) 0x01u << SPIS_1_INTR_TX_UART_DONE_POS)
#define SPIS_1_INTR_TX_UART_ARB_LOST      ((uint32) 0x01u << SPIS_1_INTR_TX_UART_ARB_LOST_POS)
...
#define SPIS_1_INTR_RX_NOT_EMPTY          ((uint32) 0x01u << SPIS_1_INTR_RX_NOT_EMPTY_POS)
#define SPIS_1_INTR_RX_FULL               ((uint32) 0x01u << SPIS_1_INTR_RX_FULL_POS)
#define SPIS_1_INTR_RX_OVERFLOW           ((uint32) 0x01u << SPIS_1_INTR_RX_OVERFLOW_POS)
#define SPIS_1_INTR_RX_UNDERFLOW          ((uint32) 0x01u << SPIS_1_INTR_RX_UNDERFLOW_POS)
#define SPIS_1_INTR_RX_BLOCKED            ((uint32) 0x01u << SPIS_1_INTR_RX_BLOCKED_POS)
#define SPIS_1_INTR_RX_FRAME_ERROR        ((uint32) 0x01u << SPIS_1_INTR_RX_FRAME_ERROR_POS)
#define SPIS_1_INTR_RX_PARITY_ERROR       ((uint32) 0x01u << SPIS_1_INTR_RX_PARITY_ERROR_POS)
#define SPIS_1_INTR_RX_BAUD_DETECT        ((uint32) 0x01u << SPIS_1_INTR_RX_BAUD_DETECT_POS)
#define SPIS_1_INTR_RX_BREAK_DETECT       ((uint32) 0x01u << SPIS_1_INTR_RX_BREAK_DETECT_POS)
...
/* Write interrupt source: set sourceMask bits in SPIS_1_INTR_X_MASK_REG */
...
/* Enable interrupt source: set sourceMask bits in SPIS_1_INTR_X_MASK_REG */
...
/* Disable interrupt source: clear sourceMask bits in SPIS_1_INTR_X_MASK_REG */
...
/* Set interrupt sources: write sourceMask bits in SPIS_1_INTR_X_SET_REG */
...
/* Clear interrupt sources: write sourceMask bits in SPIS_1_INTR_X_REG */
...
#define SPIS_1_CHECK_INTR_I2C_EC(sourceMask)  (0u != (SPIS_1_INTR_I2C_EC_REG & (sourceMask)))
#define SPIS_1_CHECK_INTR_SPI_EC(sourceMask)  (0u != (SPIS_1_INTR_SPI_EC_REG & (sourceMask)))
...
#define SPIS_1_I2C_SLAVE_CLEAR_NACK \
                            do{               \
                                SPIS_1_I2C_SLAVE_CMD_REG = 0u; \
                            }while(0)
...
/* Return true if bit is set in SPIS_1_I2C_STATUS_REG */
#define SPIS_1_CHECK_I2C_STATUS(sourceMask)   (0u != (SPIS_1_I2C_STATUS_REG & (sourceMask)))

/* Return true if bit is set in SPIS_1_SPI_STATUS_REG */
...
*/
#define SPIS_1_CHECK_INTR_EC_I2C(sourceMask)  SPIS_1_CHECK_INTR_I2C_EC(sourceMask)
#define SPIS_1_CHECK_INTR_EC_SPI(sourceMask)  SPIS_1_CHECK_INTR_SPI_EC(sourceMask)
