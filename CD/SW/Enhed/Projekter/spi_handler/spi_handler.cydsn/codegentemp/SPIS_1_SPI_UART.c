...
***************************************/
    ...
    volatile uint8 SPIS_1_rxBufferInternal[SPIS_1_RX_BUFFER_SIZE];
#endif /* (SPIS_1_INTERNAL_RX_SW_BUFFER) */

#if(SPIS_1_INTERNAL_TX_SW_BUFFER)
    volatile uint8 SPIS_1_txBufferInternal[SPIS_1_TX_BUFFER_SIZE];
    ...
    void SPIS_1_SpiUartWriteTxData(uint32 txData)
    {
        ...
        #if(SPIS_1_CHECK_TX_SW_BUFFER)
        {
            ...
            else
            {
                ...
                SPIS_1_PutWordInTxBuffer(locHead, txData);
