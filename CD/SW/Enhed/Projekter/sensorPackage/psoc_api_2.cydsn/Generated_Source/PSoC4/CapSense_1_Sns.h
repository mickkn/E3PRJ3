...
#define CapSense_1_Sns_DM_ALG_HIZ         (0x00u << CapSense_1_Sns_DRIVE_MODE_SHIFT)
#define CapSense_1_Sns_DM_DIG_HIZ         (0x01u << CapSense_1_Sns_DRIVE_MODE_SHIFT)
#define CapSense_1_Sns_DM_RES_UP          (0x02u << CapSense_1_Sns_DRIVE_MODE_SHIFT)
#define CapSense_1_Sns_DM_RES_DWN         (0x03u << CapSense_1_Sns_DRIVE_MODE_SHIFT)
#define CapSense_1_Sns_DM_OD_LO           (0x04u << CapSense_1_Sns_DRIVE_MODE_SHIFT)
#define CapSense_1_Sns_DM_OD_HI           (0x05u << CapSense_1_Sns_DRIVE_MODE_SHIFT)
#define CapSense_1_Sns_DM_STRONG          (0x06u << CapSense_1_Sns_DRIVE_MODE_SHIFT)
#define CapSense_1_Sns_DM_RES_UPDWN       (0x07u << CapSense_1_Sns_DRIVE_MODE_SHIFT)
