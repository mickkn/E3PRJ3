...
uint8 CapSense_CSD_lowBaselineReset[CapSense_CSD_TOTAL_IMMUNITY_NUM] = {
    30u, 30u, 30u, 30u, 30u, 
};
...
#if (CapSense_CSD_TUNING_METHOD == CapSense_CSD__TUNING_AUTO)
	extern CapSense_CSD_CONFIG_TYPE_P4_v2_0 CapSense_CSD_config;
#endif  /* (CapSense_CSD_TUNING_METHOD == CapSense_CSD__TUNING_AUTO) */
...
static const uint8 CapSense_CSD_posFiltersMask[] = {
    0x8u, 
};
...
*  Loads the CapSense_CSD_debounceCounter[sensor] array element with the initial 
...
void CapSense_CSD_UpdateBaselineNoThreshold(uint32 sensor)
{
	...
	#if (CapSense_CSD_TUNING_METHOD == CapSense_CSD__TUNING_AUTO)
	    MeasureNoiseEnvelope_P4_v2_0(&CapSense_CSD_config, (uint8)sensor, CapSense_CSD_sensorRaw);
	#endif /* (CapSense_CSD_TUNING_METHOD == CapSense_CSD__TUNING_AUTO) */
