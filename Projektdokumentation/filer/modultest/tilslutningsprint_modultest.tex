% Tilslutningsprint
Der er lavet modultest på tilslutningsprintet ud fra følgende tabel \ref{lab:modultest_tilslutningsprint}, forventnings resultater tager udgangspunkt i HW design delen.
