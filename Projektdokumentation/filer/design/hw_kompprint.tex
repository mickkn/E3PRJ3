...
For at frigøre sig fra laboratoriets strømforsyningerne udarbejdes egen strømforsyning. Vha. en 230VAC/12VDC switch-mode konverter og egnede spændingens-regulatorer designes en strømforsyning til netop dette projekt. Masteren (DevKit8000) har sin egen strømforsyning og denne ændres ikke. Enheden (PSoC4) skal forsynes med 5VDC via USB. Relæstyringen skal forsynes med 5VDC. PIR sensoren skal forsynes med 5-20 VDC. Temperatur/fugt sensoren skal forsynes med 3,3VDC. 
...
Spændingsregulatoren LM7805 er opbygget i Multisim se figur \ref{lab:LM7805_SIMULERING}, sammen med 12VDC forsyningen. Kredløbet er simuleret og dette viser at outputtet er de ønskede 5 V.
