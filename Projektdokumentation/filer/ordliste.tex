...
\item[HW] Hardware
\item[IBD] Internal Block Diagram (Internt blokdiagram)
...
\item[PSU] Power Supply Unit (strømforsyning)
\item[PWM] Puls-Width Modulation (Puls bredde modulation) - PWM spænding
\item[SW] Software
