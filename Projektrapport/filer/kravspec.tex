...
Der er blevet lavet en kravspecifikation, som tager udgangspunkt i usecase diagrammet på figur \ref{lab:usecasediagram}. Usecase diagrammet viser hvilke usecases som Bruger og Golfbane har kontakt til, den komplette usecase beskrivelse kan ses i projektdokumentationen\footnote{Projektdokumentation, Kapitel 2, kravspec}
