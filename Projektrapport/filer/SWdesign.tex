...
\figur{1}{a_uc2}{Sekvensdiagram fra applikationsmodel. Viser forløbet igennem programmet}{fig:devkit_a_uc2}
...
\figur{1}{sw_class_devkit}{klassediagram fra applikationsmodellen. Giver en beskrivelse af klasse med tilhørende metoder og attributter}{fig:devkit_class}
